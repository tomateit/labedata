...
class User():
    ...
    @staticmethod
    def register_new_user(username=None, password=None, login=None, email=None, **kwargs) -> str:
        error = None
    ...
    @staticmethod
    def authenticate(login: str=None, password: str=None)-> Tuple[Union[None, Dict[str,str]], Union[str, None]]:
        error = None
        if not login:
